...
--12. Set Unique Field
ALTER TABLE Users
DROP CONSTRAINT PK__Users_Id_Username
...
('Chainsaw', 2, '2015', 120, 3, 5, 1, NULL),
('TOP GUN', 3, '1986', 120, 1, 2, 2, NULL),
('Nemo', 4, '2003', 120, 4, 5, 3, NULL),
('Memento', 5, '2000', 120, 5, 4, 4, NULL),
('Titanik', 1, '1997', 120, 2, 3, 5, NULL)
...
TO DISK = 'D:\MSSQL_local_DB\softuni-backup.bak'
GO
...
FROM DISK = 'D:\MSSQL_local_DB\softuni-backup.bak'
GO
